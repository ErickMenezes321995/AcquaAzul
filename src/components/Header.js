...
function Header() {
    ...
    const navItems = [
        { label: 'Sobre', href: '#sobre', icon: <Info sx={{ mr: 1, fontSize: 18 }} /> },
        { label: 'Programas', href: '#programas', icon: <Pool sx={{ mr: 1, fontSize: 18 }} /> },
        { label: 'Benefícios', href: '#beneficios', icon: <Star sx={{ mr: 1, fontSize: 18 }} /> },
                ...
                <Box sx={{ 
                    ...
                    <Grow in={mounted} timeout={1000}>
                        <Box sx={{ 
                            ...
                            <Pool sx={{ fontSize: { xs: 20, md: 24 } }} />
                            Natação para Crianças
                        </Box>
                    </Grow>

                    {/* Main Heading */}
                    <Slide direction="down" in={mounted} timeout={1500}>
                        <Typography
                            variant="h1"
                            sx={{
                                fontSize: { 
                    ...
                    <Fade in={mounted} timeout={2000}>
                        ...
                        >
                            Aulas de natação especializadas para crianças de 6 meses a 12 anos. 
                            Professores qualificados e ambiente seguro.
                        </Typography>
                    </Fade>
